...
* **User Persona:** Assume the user is familiar with Flutter development and Dart programming
* **Explanations:** Provide clear, concise explanations with code examples
* **Clarification:** If a request is ambiguous, ask clarifying questions before implementation
* **Dependencies:** Suggest dependencies that align with current Flutter best practices
...
│   └── utils/                   # Utility functions (dialogs, snackbars)
├── presentation/                # UI Layer
│   ├── features/                # Feature modules
│   └── widgets/                 # Reusable widgets
├── repos/                       # Repository layer (Data access)
└── services/                    # Service layer (External services)
```
...
│       └── screen_name/         # Organized by screen
```

## 🎯 State Management with Riverpod

### AsyncNotifier Pattern (RECOMMENDED)
Use **AsyncNotifier** for complex business logic with async operations.
...
class FeatureState {
  ...
  /// Always include copyWith for state updates
